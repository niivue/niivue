...
export class NVMeshLoaders {
    ...
    static async readMZ3(buffer: ArrayBuffer, n_vert = 0): Promise<MZ3> {
        ...
        utiltiesLogger.debug(`isFace=${isFace} isVert=${isVert} isRGBA=${isRGBA} isSCALAR=${isSCALAR} isDOUBLE=${isDOUBLE} isAOMAP=${isAOMAP} isLOOKUP=${isLOOKUP}`)
        if (attr > 127) {
    ...
    static async readNII2(buffer: ArrayBuffer, n_vert = 0, anatomicalStructurePrimary = ''): Promise<Int32Array | Float32Array | Int16Array | Uint8Array> {
        ...
        if (intent_code >= 3000 && intent_code <= 3099 && voxoffset > 580) {
            ...
            log.debug('CIfTI diagnostics', surfaceNumberOfVertices, brainStructure, indexOffset, indexCount, indexOffset, anatomicalStructurePrimary)
            //
            return scalars
        } // is CIfTI
    ...
    static async readNII(buffer: ArrayBuffer, pts: Float32Array, anatomicalStructurePrimary = ''): Promise<Float32Array | Uint8Array | Int32Array | Int16Array> {
