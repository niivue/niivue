 ...
 */
export function getCrossLinesForSliceType(
  axCorSag: SLICE_TYPE,
  axiMM: number[],
  corMM: number[],
  sagMM: number[]
): { linesH: number[]; linesV: number[] } {
 ...
 */
export function determineRadiologicalConvention(
  axCorSag: SLICE_TYPE,
 ...
 */
export function calculateSliceDimensions(
