...
export const groupedConfigMeta = {
  Text: [
    ...
    [
      ...
      { type: 'boolean', requiresDraw: true, requiresUpdateGLVolume: false }
    ],
    [
  ...
  SlicingAndMosaic: [
    [
      'sliceType',
      { type: 'enum', enum: 'SLICE_TYPE', requiresDraw: false, requiresUpdateGLVolume: true }
    ],
    [
      'heroSliceType',
      { type: 'enum', enum: 'SLICE_TYPE', requiresDraw: false, requiresUpdateGLVolume: true }
  ...
  Interaction: [
    ...
    [
      'dragMode',
      { type: 'enum', enum: 'DRAG_MODE', requiresDraw: false, requiresUpdateGLVolume: true }
    ],
    [
      'dragModePrimary',
      { type: 'enum', enum: 'DRAG_MODE_PRIMARY', requiresDraw: false, requiresUpdateGLVolume: true }
    ],
    [
      'isForceMouseClickToVoxelCenters',
      { type: 'boolean', requiresDraw: false, requiresUpdateGLVolume: true }
    ],
  ...
  MultiPlanarViews: [
    ...
    [
      ...
      { type: 'enum', enum: 'SHOW_RENDER', requiresDraw: false, requiresUpdateGLVolume: true }
    ],
    [
      'multiplanarLayout',
      { type: 'enum', enum: 'MULTIPLANAR_TYPE', requiresDraw: false, requiresUpdateGLVolume: true }
    ]
  ],
  Legend: [['showLegend', { type: 'boolean', requiresDraw: true, requiresUpdateGLVolume: false }]],
  File: [['thumbnail', { type: 'text', requiresDraw: false, requiresUpdateGLVolume: false }]],
  Canvas: [
