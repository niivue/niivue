  ...
  return (
    <div className="flex flex-row">
      ...
      <div className="flex flex-col items-center justify-center mx-1">
        <Button onClick={handleL} className="font-mono" color="gray">
          L
        </Button>
      </div>
      ...
      <div className="flex flex-col items-center justify-center space-y-1 mx-1">
        <Button onClick={handleA} className="font-mono" color="gray">
          A
        </Button>
        <Button onClick={handleP} className="font-mono" color="gray">
          P
        </Button>
      </div>
      {/* column for the R button, centered vertically and horizontally in the column */}
      <div className="flex flex-col items-center justify-center mx-1">
        <Button onClick={handleR} className="font-mono" color="gray">
          R
        </Button>
      </div>
      {/* column for the S and I buttons */}
      <div className="flex flex-col items-center justify-center space-y-1 ml-4 mr-4">
        <Button onClick={handleS} className="font-mono" color="gray">
          S
        </Button>
        <Button onClick={handleI} className="font-mono" color="gray">
          I
        </Button>
      </div>
    </div>
