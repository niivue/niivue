...
This page describes the NiiVue format for storing these transforms. NiiVue comes with many built-in colormaps. The [colormap live demo](https://niivue.com/demos/features/colormaps.html) allows you to explore these colormaps as well as define custom colormaps.

## Basics

 You can paste the code snippets below into the [colormap live demo](https://niivue.com/demos/features/colormaps.html) and press the `custom` button to see these colormaps in action. We define the red, green, blue, alpha (RGBA) values with 8 bits per component (0..255).
...
```
![colormap1](/img/pages/colormap1.png)
...
![colormap2](/img/pages/colormap2.png)
...
![colormap3](/img/pages/colormap3.png)
...
```
![colormap4](/img/pages/colormap4.png)
...
Consider an MRI scan that has been segmented with [FSL FIRST](https://fsl.fmrib.ox.ac.uk/fsl/fslwiki/FIRST). This can generate a volume where there are discrete tissues that we will want to map to specific colors and label with names. In this case, the segmented image may have the intensities 0 for Air, 1 for water, 2 for gray matter and 3 for white matter. This [labeled live demo](https://niivue.com/demos/features/segment.html) uses this colormap:
...
The [labeled voxel live demo](https://niivue.com/demos/features/segment.html) and [labeled mesh live demo](https://niivue.com/demos/features/mesh.atlas.gii.html) allow you to interactively change the colormaps.

## Links

 - NiiVue includes the [viridism color schemes](https://jmsallan.netlify.app/blog/the-viridis-palettes/) which are perceptually-uniform and easier to read by those with colorblindness.
 - Many NiiVue colormaps [are adjusted for improved perceptual uniformity](https://github.com/CPernet/brain_colours).
 - Several included [scientific colormaps](https://www.fabiocrameri.ch/colourmaps/) were developed by [Crameri and colleagues](https://pubmed.ncbi.nlm.nih.gov/33116149/).
