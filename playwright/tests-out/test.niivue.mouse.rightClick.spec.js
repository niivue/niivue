...
;(0, test_1.test)('niivue mouse right click and drag draws selection box', async ({ page }) => {
...
;(0, test_1.test)('niivue mouse right click, drag and up sets intensity range', async ({ page }) => {
  await page.evaluate(async (testOptions) => {
    // eslint-disable-next-line no-undef
    const nv = new index_1.Niivue(testOptions)
    await nv.attachTo('gl')
...
// # sourceMappingURL=test.niivue.mouse.rightClick.spec.js.map
