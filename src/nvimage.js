 ...
 */
 nifti.NIFTI1.convertNiftiOneHeaderToArrayBuffer = function(header) {
  ...
  view.setInt16(72, header.numBitsPerVoxel, header.littleEndian);
  ...
  view.setFloat32(116, header.scl_inter, header.littleEndian);
  ...
  view.setFloat32(264, header.quatern_d, header.littleEndian);
  view.setFloat32(268, header.qoffset_x, header.littleEndian);
  view.setFloat32(272, header.qoffset_y, header.littleEndian);
 ...
 */
 NVImage.convertNiftiTwoHeaderToArrayBuffer = function(header) {
  ...
  // intent_p1
  view.setFloat64(80, header.intent_p1, header.littleEndian);

  // intent_p2
  view.setFloat64(88, header.intent_p2, header.littleEndian);
  ...
  // vox_offset
  view.setBigInt64(168, BigInt(header.vox_offset), header.littleEndian);

  // scl_slope
  view.setFloat64(176, header.scl_slope, header.littleEndian);

  // scl_inter
  view.setFloat64(184, header.scl_inter, header.littleEndian);

  // cal_max
  view.setFloat64(192, header.cal_max, header.littleEndian);

  // cal_min
  view.setFloat64(200, header.cal_min, header.littleEndian);

  // slice_duration
  view.setFloat64(208, header.slice_duration, header.littleEndian);

  // toffset
  view.setFloat64(216, header.toffset, header.littleEndian);

  // slice_start
  view.setBigInt64(224, BigInt(header.slice_start), header.littleEndian);
  ...
  // qform_code
  view.setInt32(344, header.qform_code, header.littleEndian);

  // sform_code
  view.setInt32(348, header.sform_code, header.littleEndian);

  // quatern_b
  view.setFloat64(352, header.quatern_b, header.littleEndian);
  ...
  // slice_code
  view.setInt32(496, header.slice_code, header.littleEndian);
  //  xyzt_units
  view.setInt32(500, header.xyzt_units, header.littleEndian);
  //  intent_code
