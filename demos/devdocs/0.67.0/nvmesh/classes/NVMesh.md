...
| <a id="nodes"></a> `nodes?`                                          | \| `NVConnectomeNode`[] \| [`LegacyNodes`](../../types/type-aliases/LegacyNodes.md)                                                           | `undefined`     | [nvmesh.ts:197](https://github.com/niivue/niivue/blob/main/packages/niivue/src/nvmesh.ts#L197) |
