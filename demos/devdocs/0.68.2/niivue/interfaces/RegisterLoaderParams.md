...
| <a id="loader"></a> `loader`   | (`data`: `string` \| `Uint8Array` \| `ArrayBuffer`) => `Promise`\<`any`\> | [niivue/data/FileLoader.ts:170](https://github.com/niivue/niivue/blob/main/packages/niivue/src/niivue/data/FileLoader.ts#L170) |
